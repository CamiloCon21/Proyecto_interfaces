...
export class Service {
    ...
    llamar(){
        ...
        const urlAPI = "https://gateway.marvel.com:443/v1/public/characters?apikey="+apikey+"&hash="+hash+"&ts="+this.ts+"";
        let contentHTML = '';
    ...
    fetch(urlAPI)
      ...
      return this.http.get<any>("https://gateway.marvel.com:443/v1/public/characters?apikey="+apikey+"&hash="+hash+"&ts="+this.ts+"").pipe(map((data: any)=>data.data.results));
  }
